...
#ifndef _MY_REGISTRY_STUFF_
#define _MY_REGISTRY_STUFF_

//Create, write and read registry keys and values

//global
static HKEY g_hkey=NULL;
static TCHAR g_subkey[MAX_PATH+1]=L"Software\\wireless forced on";
...
int OpenKey()
{
	...
	LONG rc = RegOpenKeyEx(
        ...
        0, 
        &g_hkey);
	DEBUGMSG(1, (L"OpenKey returns handle %i\n", g_hkey));
	if (rc == ERROR_SUCCESS)
		return 0;
	else
	{
